...
**Module 3 — Tern Prompt Engineering**
...
- Use AI to generate boilerplate, entities, and service layers in ASP.NET Core 8
- Use AI to explain legacy code and unfamiliar codebases
- Apply refactoring strategies with AI: modernizing code safely
- Generate unit tests (xUnit/Moq) with AI assistance
...
**Today:** Learn **what** to prompt for in .NET/C# development.

---

## Code generation: the problem

**Scenario:** You need a Book entity with Entity Framework Core annotations, repository, and service method

---

**Manual approach:**

- ❌ Write entity, add annotations, create repository abstraction, write service method
...
- ✅ Consistent: Follows ASP.NET Core patterns

---

**Prompt example:**

> "Generate an ASP.NET Core 8 Entity Framework Core entity for a Book with fields: id (long, primary key), title (string), author (string), isbn (string, unique), publishedYear (int). Use C# 12."
...
**Initial output** (maybe uses service-locator style injection):

```csharp
service-locator style injection
...
**Scenario:** You inherited an ASP.NET Web Forms/WCF component you don't understand
...
- ❌ Not modern: C# 12 features not used
...
> "Refactor this method to use C# 12 LINQ. Extract null checks into filters. Improve readability while maintaining the same behavior."

**AI suggests:**

- ✅ LINQ-based refactor
- ✅ More readable: Functional style
- ✅ Modern: Uses C# 12 features
...
**Strategy 2:** Replace loops with LINQ

**Strategy 3:** Add null-safety (nullable reference types, null checks)
...
> "Generate xUnit and Moq tests for this service method. Cover happy path, null input, and empty list scenarios. Use C# 12."
...
## Review before past (or accept): the problem

**Example:** AI generates code with wrong API

**Problems:**

- ❌ Wrong version: Uses ASP.NET Core 6 patterns instead of 8
...
- ✅ **Version:** Right ASP.NET Core/C# version?
...
- ASP.NET Core 6 vs. 8 APIs
- older C# patterns vs. C# 12 features

---

**Deprecated patterns:**

- service-locator style injection vs. constructor injection
...
- **What** to prompt for in .NET/C# development (generation, explanation, refactoring, testing)
...
_Module 3 — AI-Assisted .NET/C# Development_
