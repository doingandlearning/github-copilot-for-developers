...
- Use these techniques for technical problem-solving in chat tools (e.g. GitHub Copilot for Business).
...
- nullable reference types: chain-of-thought on a small debugging or design question.

## Suggested exercises

- **Lab:** Craft effective prompts for a technical problem (e.g. “explain this regex” or “suggest a refactor”) using technical chat / GitHub Copilot for Business; compare with a partner.
